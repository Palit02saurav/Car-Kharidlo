...
class Tata_Nexon : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_tata_nexon)
    ...
    private fun openWhatsappChat() {
        val message = "Hello! I want more details about Tata Nexon."
